...
/**
 * Lightweight rich-text editor (bold, italic, headings, lists, links).
 * Produces HTML, stored as a string and rendered on the blog page.
 * Dependency-free; works RTL and LTR.
 */
