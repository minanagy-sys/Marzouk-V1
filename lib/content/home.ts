...
export function homeContent(lang: Lang) {
  ...
  const t = isAr
    ? {
        ...
        revKicker: "آراء المرضى",
        revTitle: "ماذا قالوا عنا",
        igKicker: "إنستجرام",
        igTitle: "تابعونا على إنستجرام",
        igFollow: "متابعة",
        igViewIg: "عرض على إنستجرام",
        igVideo: "فيديو",
        igPost: "منشور",
    ...
    : {
        ...
        revKicker: "Patient reviews",
        revTitle: "What they said about us",
        igKicker: "Instagram",
        igTitle: "Follow us on Instagram",
        igFollow: "Follow",
        igViewIg: "View on Instagram",
        igVideo: "Video",
        igPost: "Post",
