...
export const COLLECTIONS: Record<string, Collection> = {
  ...
  services: {
    ...
    fields: [
      ...
      { name: "image_url", label: "Card image — Services page (masonry)", type: "image", group: "Basics", help: "Shown on the Services page grid and the service detail page." },
      { name: "image_url_home", label: "Card image — Home page slider", type: "image", group: "Basics", help: "Shown on the home-page services slider (different shape). If empty, the Services-page image is used." },
  ...
  blog_posts: {
    ...
    fields: [
      ...
      { name: "image_alt_ar", label: "Cover image alt text (Arabic)", type: "text", group: "Basics", help: "Describes the image for SEO & accessibility" },
      { name: "image_alt_en", label: "Cover image alt text (English)", type: "text", group: "Basics" },
      ...
      {
        name: "faq", label: "FAQ (shown on the page + FAQ schema)", type: "repeater", group: "FAQ", itemLabel: "Question",
        subfields: [
          { name: "q_ar", label: "Question (Arabic)", type: "text" },
          { name: "q_en", label: "Question (English)", type: "text" },
          { name: "a_ar", label: "Answer (Arabic)", type: "textarea" },
      ...
      { name: "meta_desc_ar", label: "SEO description (Arabic)", type: "textarea", group: "SEO" },
      { name: "meta_desc_en", label: "SEO description (English)", type: "textarea", group: "SEO" },
      { name: "keywords_ar", label: "Focus keywords (Arabic)", type: "text", group: "SEO", help: "Comma-separated" },
      { name: "keywords_en", label: "Focus keywords (English)", type: "text", group: "SEO", help: "Comma-separated" },
      { name: "schema_type", label: "Schema type", type: "select", options: ["BlogPosting", "Article", "NewsArticle", "MedicalWebPage"], group: "SEO", help: "Structured data type for search engines" },
    ],
  },
